            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-9">
                    <div class="about__images-three tg-svg">
                        <img src="${pageContext.request.contextPath}/view/user/assets/img/others/inner_about_img.png" alt="img">
                        <span class="svg-icon" id="about-svg" data-svg-icon="${pageContext.request.contextPath}/view/user/assets/img/others/inner_about_shape.svg"></span>
                ...
                <div class="col-lg-6">
                    <div class="about__content-three">
                        ...
                        <div class="tg-button-wrap">
                            <a href="contact.html" class="btn arrow-btn">Start Free Trial <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="marquee_mode">
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand01.png" alt="brand"></a>
                    <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/brand_star.svg" alt="star">
                </div>
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand02.png" alt="brand"></a>
                    <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/brand_star.svg" alt="star">
                </div>
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand03.png" alt="brand"></a>
                    <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/brand_star.svg" alt="star">
                </div>
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand04.png" alt="brand"></a>
                    <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/brand_star.svg" alt="star">
                </div>
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand05.png" alt="brand"></a>
                    <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/brand_star.svg" alt="star">
                </div>
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand06.png" alt="brand"></a>
                    <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/brand_star.svg" alt="star">
                </div>
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand07.png" alt="brand"></a>
                    <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/brand_star.svg" alt="star">
                </div>
                <div class="brand__item">
                    <a href="#"><img src="${pageContext.request.contextPath}/view/user/assets/img/brand/brand04.png" alt="brand"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="features__item-two">
                            <div class="features__content-two">
                                <div class="content-top">
                                    <div class="features__icon-two">
                                        <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/h2_features_icon01.svg" alt="img" class="injectable">
                                    </div>
                            ...
                            <div class="features__item-shape">
                                <img src="${pageContext.request.contextPath}/view/user/assets/img/others/features_item_shape.svg" alt="img" class="injectable">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="features__item-two">
                            <div class="features__content-two">
                                <div class="content-top">
                                    <div class="features__icon-two">
                                        <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/h2_features_icon02.svg" alt="img" class="injectable">
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="features__item-two">
                            <div class="features__content-two">
                                <div class="content-top">
                                    <div class="features__icon-two">
                                        <img src="${pageContext.request.contextPath}/view/user/assets/img/icons/h2_features_icon03.svg" alt="img" class="injectable">
                                    </div>
                                        ...
                                        <div class="testimonial__item-top">
                                            <div class="testimonial__author">
                                                <div class="testimonial__author-thumb">
                                                    <img src="${pageContext.request.contextPath}/view/user/assets/img/others/testi_author01.png" alt="img">
                                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        <div class="testimonial__item-top">
                                            <div class="testimonial__author">
                                                <div class="testimonial__author-thumb">
                                                    <img src="${pageContext.request.contextPath}/view/user/assets/img/others/testi_author02.png" alt="img">
                                                </div>
                                                <div class="testimonial__author-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        <div class="testimonial__item-top">
                                            <div class="testimonial__author">
                                                <div class="testimonial__author-thumb">
                                                    <img src="${pageContext.request.contextPath}/view/user/assets/img/others/testi_author03.png" alt="img">
                                                </div>
                                                <div class="testimonial__author-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
