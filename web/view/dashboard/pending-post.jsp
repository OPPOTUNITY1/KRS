            ...
            <div class="row">
                <div class="col-md-9">
                    <ul class="list-links mb-4">
                        <li><a href="blog">Active Blog</a></li>
                        <li class="active"><a href="pending-blog">Pending Blog</a></li>
                    </ul>
                </div>
                <div class="col-md-3 text-md-end">
                    <a href="add-blog" class="btn btn-primary btn-blog mb-3"><i class="feather-plus-circle me-1"></i>
                        Add New</a>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                    <div class="blog grid-blog flex-fill">
                        <div class="blog-image">
                            <a href="blog-details"><img class="img-fluid" src="${pageContext.request.contextPath}/view/dashboard/assets/img/category/blog-6.jpg"
                                                        alt="Post Image"></a>
                        ...
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="profile">
                                            <img src="${pageContext.request.contextPath}/view/dashboard/assets/img/profiles/avatar-01.jpg" alt="Post Author">
                                            <span>
                            ...
                            <h3 class="blog-title"><a href="blog-details">Learning is an objective, Lorem Ipsum is
                                not </a></h3>
                        ...
                        <div class="row">
                            <div class="edit-options">
                                <div class="edit-delete-btn">
                                    <a href="edit-blog" class="text-success"><i class="feather-edit-3 me-1"></i>
                                        Edit</a>
