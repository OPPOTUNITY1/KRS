...
<%--                            <label for="searchByManager"></label>--%>
<%--                            <input type="text" id="searchByManager" class="form-control" placeholder="Search by Manager ..."/>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                    <div class="col-lg-5 col-md-6">--%>
<%--                        <div class="input-block">--%>
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="${pageContext.request.contextPath}/manager-subject/new" class="btn btn-primary">
                                ...
                                <div class="card top-selling overflow-auto">
                                    <div class="card-body pb-0">
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                <c:forEach varStatus="status" items="${requestScope.subjects}" var="subject">
                                                    <tr>
