        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="update?lesson_id=${requestScope.lessonId}" method="post">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <input name="lesson_title" id="lesson_title" value="${requestScope.lesson.getTitle()}" type="text" class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <input id="video_url" name="video_url" type="text" value="${requestScope.lesson.getVideo_url()}" class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <input id="description" name="description" type="text" value="${requestScope.lesson.getDescription()}" class="form-control"/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-block local-forms">
                                            ...
                                            <select id="subject" name="subject" class="form-control">
                                                <c:forEach items="${requestScope.subjects}" var="subject">
                                                    <option value="${subject.subject_id}" ${requestScope.lesson != null && requestScope.lesson.subject_id == subject.subject_id ? 'selected="selected"' : ''}>${subject.subject_name}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body" style="padding: 0">
                                                    <textarea name="content" id="summernote">${requestScope.lesson.getContent()}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
