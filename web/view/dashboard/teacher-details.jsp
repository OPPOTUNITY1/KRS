                        ...
                        <div class="col-md-12">
                            ...
                            <div class="student-profile-head">
                                <div class="profile-bg-img">
                                    <img src="${pageContext.request.contextPath}/view/dashboard/assets/img/profile-bg.jpg" alt="Profile"/>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="profile-user-box">
                                            <div class="profile-user-img">
                                                <img
                                                        src="${pageContext.request.contextPath}/view/dashboard/assets/img/profiles/avatar-18.jpg"
                                                        alt="Profile"
                                                />
                                                <div
                                                        class="input-block students-up-files profile-edit-icon mb-0"
                                                >
                            ...
                            <div class="student-personals-grp">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                                <img src="${pageContext.request.contextPath}/view/dashboard/assets/img/icons/buliding-icon.svg" alt="Img"/>
                                            </div>
                                            <div class="views-personal">
                                                <h4>Department</h4>
                                                <h5>Electronics</h5>
